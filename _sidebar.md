...
* [快速开始](/cli/intro)
* 命令列表
    * [api](/cli/cmd/ucloud/api)
    * [bw](/cli/cmd/ucloud/bw)
    ...
    * [memcache](/cli/cmd/ucloud/memcache)
    ...
    * [pathx](/cli/cmd/ucloud/pathx)
        * [area](/cli/cmd/ucloud/pathx/area)
            * [list](/cli/cmd/ucloud/pathx/area/list)
        * [create](/cli/cmd/ucloud/pathx/create)
        * [delete](/cli/cmd/ucloud/pathx/delete)
        * [list](/cli/cmd/ucloud/pathx/list)
        * [modify](/cli/cmd/ucloud/pathx/modify)
        * [price](/cli/cmd/ucloud/pathx/price)
            * [list](/cli/cmd/ucloud/pathx/price/list)
    ...
    * [project](/cli/cmd/ucloud/project)
    ...
    * [uphost](/cli/cmd/ucloud/uphost)
        * [list](/cli/cmd/ucloud/uphost/list)
    * [vpc](/cli/cmd/ucloud/vpc)
