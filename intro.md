...
UCloud CLI为管理UCloud平台上的资源和服务提供了一致性的操作接口，它使用[ucloud-sdk-go](https://github.com/ucloud/ucloud-sdk-go)调用[UCloud OpenAPI](https://docs.ucloud.cn/api/summary/README)，从而实现对资源和服务的操作，兼容Linux, macOS和Windows平台 https://docs.ucloud.cn/cli/README
...
把如下代码添加到文件 “$HOME/.bash_profile” 或 “$HOME/.bashrc”中，然后source <$HOME/.bash_profile|$HOME/.bashrc>，或打开一个新终端，命令补全即生效
...
```
$ ucloud gssh create --location US(Washington) --target-ip 152.32.140.92
